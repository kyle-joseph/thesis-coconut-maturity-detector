...
import 'package:coconut_maturity_detector/screens/hybrid/acoustic.dart';
  ...
  Future captureImage(BuildContext context) async {
    ...
    try {
      ...
      Provider.of<ApplicationState>(context, listen: false)
          .setHybridLabels(prediction![0]["label"]);
      Provider.of<ApplicationState>(context, listen: false)
          .setHybridScores(prediction[0]["confidence"]);

      await Navigator.pushReplacement(
        context,
        CupertinoPageRoute(
          builder: (context) => HybridAcousticScreen(),
        ),
      );
      // ignore: avoid_print
    } catch (e) {
